...
<video controls>
  <source src="https://localhost:22138/Computer Vision - Optical Flow/reveal.js/assets/videos/video1.mp4">
</video>
"""
...
class JBImage( JBData ):
    ...
    def __repr_html_file__(self, style= ""):
        return '<img src="http://localhost:{port}/{src}{ext}" style="{style}" alt="{name}"/>'.format(src=self.localFile, ext=self.ext, port=HTTP_PORT, name=self.name, style=style)
